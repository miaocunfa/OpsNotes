...
backupTar=gitlab-229-backup-$weekday.tar

remoteHost=n238
remoteDir=/root/gitlab/backup
...
tar -cvf $backupTar $backupFile

__write_log "log" "gitlab-backupFile: $backupTar"
scp $backupTar root@$remoteHost:$remoteDir
...
then
    ...
    __write_log "log" "Remove file: $backupTar"
...
# Send Mail to admin
echo $mailContext | mail -s "gitlab-229 $curDate 备份" shu-xian@126.com
echo $mailContext | mail -s "gitlab-229 $curDate 备份" miaocunf@126.com
